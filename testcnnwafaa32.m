...
clear
clc
imdsTrain=imageDatastore('D:\Doaa_PHD\PHD2020\2nd paper\code\dataset\CK48','IncludeSubfolders',true,'LabelSource', 'foldernames')
imdsTrain.ReadFcn = @(filename)readAndPreprocessImage(filename);

imdsValidation=imageDatastore('D:\Doaa_PHD\PHD2020\2nd paper\code\dataset\jaffedbase - Copy','IncludeSubfolders',true,'LabelSource', 'foldernames')
